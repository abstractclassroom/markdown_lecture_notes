...
1. The relation $R$ is reflexive. 
   ...
   **Proof**: For any real number $x$, we have $\frac{x}{x} = 1 \in \mathbb{Q}$, hence $(x,x) \in R$ for all $x \in \mathbb{R}$.  Notice this proof is valid for all real numbers $x$ in the interval $(0,\infty)$. 
