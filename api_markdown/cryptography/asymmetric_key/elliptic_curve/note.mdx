...
![Continuous elliptic curve over the real numbers](https://abstract-classroom-teaching.s3.amazonaws.com/cryptography/asymmetric_key/elliptic_curve/ecc_real_curve.png)
...
The above result gives the following expression for $b$.
...
![Discrete points on the elliptic curve modulo 17](https://abstract-classroom-teaching.s3.amazonaws.com/cryptography/asymmetric_key/elliptic_curve/ecc_mod17_points.png)
...
![Elliptic Curve Embedded On Torus](https://abstract-classroom-teaching.s3.amazonaws.com/cryptography/asymmetric_key/elliptic_curve/elliptic_curve_torus_slope.png)
...
![Elliptic Curve Point Addition](https://abstract-classroom-teaching.s3.amazonaws.com/cryptography/asymmetric_key/elliptic_curve/point_addition.png)
...
![Elliptic Curve Point Doubling](https://abstract-classroom-teaching.s3.amazonaws.com/cryptography/asymmetric_key/elliptic_curve/point_doubling.png)
