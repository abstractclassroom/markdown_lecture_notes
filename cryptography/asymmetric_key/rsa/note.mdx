...
Notice that we are applying modular arithmetic with the modulus being 792.  This implies $792y \equiv 0 \text{ mod} 792$.  This leaves the fact that $5x =1 \text{ mod } 792$ which implies that the value $x$ is the inverse of 5.  In this case $x=317$.
